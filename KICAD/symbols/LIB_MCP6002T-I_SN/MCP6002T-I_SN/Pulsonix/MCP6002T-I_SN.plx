...
//276946/215985/2.49/8/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "MCP6002T-I_SN" (originalName "MCP6002T-I_SN")
		...
		(pin (pinNum 4) (pt 600 mils -900 mils) (rotation 90) (pinLength 200 mils) (pinDisplay (dispPinName true)) (pinName (text (pt 625 mils -670 mils) (rotation 90]) (justify "Left") (textStyleRef "Normal"))
		))
		...
		(pin (pinNum 8) (pt 600 mils 600 mils) (rotation 270) (pinLength 200 mils) (pinDisplay (dispPinName true)) (pinName (text (pt 625 mils 370 mils) (rotation 90]) (justify "Right") (textStyleRef "Normal"))
		))
	...
	(compDef "MCP6002T-I_SN" (originalName "MCP6002T-I_SN") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "5" (pinName "VINB+") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "6" (pinName "VINB-") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "7" (pinName "VOUTB") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "8" (pinName "VDD") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "MCP6002T-I_SN"))
		...
		(attr "Manufacturer_Part_Number" "MCP6002T-I/SN")
		(attr "Mouser Part Number" "579-MCP6002T-I/SN")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Microchip-Technology/MCP6002T-I-SN?qs=hul3WK2zl4od4mMZEAcUDQ%3D%3D")
		(attr "Arrow Part Number" "MCP6002T-I/SN")
		(attr "Arrow Price/Stock" "https://www.arrow.com/en/products/mcp6002t-isn/microchip-technology?region=nac")
		(attr "Description" "Op. Amplifier Dual 1MHz Low-Power SOIC8 Microchip MCP6002T-I/SN, Dual Low Power Op Amp, 1MHz Rail-Rail, 1.8  6 V, 8-Pin SOIC")
		(attr "<Hyperlink>" "https://componentsearchengine.com/Datasheets/2/MCP6002T-I_SN.pdf")
		(attr "<Component Height>" "1.75")
		(attr "<STEP Filename>" "MCP6002T-I_SN.stp")
