...
//add coils - 00,000
mb.addCoil(SetPoint_CL0);
mb.addCoil(SetPoint_CL1);
mb.addCoil(SetPoint_CL2);
mb.addCoil(SetPoint_CL3);
mb.addCoil(SetPoint_CL4);
mb.addCoil(SetPoint_CL5);
mb.addCoil(SetPoint_CL6);
mb.addCoil(SetPoint_CL7);
mb.addCoil(SetPoint_CL8);
mb.addCoil(SetPoint_CL9);
mb.addCoil(SetPoint_CL10);
mb.addCoil(SetPoint_CL11);
mb.addCoil(SetPoint_CL12);
mb.addCoil(SetPoint_CL13);
mb.addCoil(SetPoint_CL14);
mb.addCoil(SetPoint_CL15);
mb.addCoil(SetPoint_CL16);
mb.addCoil(SetPoint_CL17);
mb.addCoil(SetPoint_CL18);
mb.addCoil(SetPoint_CL19);
